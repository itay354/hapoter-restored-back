    ...
    <section id="services" className="py-16 md:py-24 bg-peach-100 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        {selectedService !== null && (
          <div 
            className="absolute bg-white rounded-xl shadow-2xl p-6 transition-all duration-500 animate-fade-in z-50 overflow-hidden"
            style={{
          ...
          >
            ...
            <div className="absolute top-0 right-0 w-20 h-20 bg-royal-100 opacity-20 transform rotate-45 translate-x-10 -translate-y-10"></div>
            <div className="absolute bottom-0 left-0 w-20 h-20 bg-coral-100 opacity-20 transform rotate-45 -translate-x-10 translate-y-10"></div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2">
                  ...
                  <div className="bg-royal-50 p-4 rounded-lg mb-4">
                    <h4 className="font-bold text-lg text-royal-600 mb-3">יתרונות השירות:</h4>
                ...
                <div className="lg:col-span-1">
                  <h4 className="font-bold text-lg text-royal-600 mb-3">דוגמאות מהעבודות שלנו:</h4>
